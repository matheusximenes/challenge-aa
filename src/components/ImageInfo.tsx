...
import heartOutlined from "../assets/iconography/heart_outlione.svg";
import heart from "../assets/iconography/heart_filled.svg";
import Image from "../assets/iconography/image-solid.svg";
      ...
      <div className="photo-info">
        ...
        {selectedPhoto.description && (
          <>
            ...
            <p className="photo-info__description">
              {selectedPhoto.description}
            </p>
          </>
        )}
